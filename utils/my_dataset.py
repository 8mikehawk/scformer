...
# train_ds = ISIC2018(train_img_root, val_img_root, train_label_root, val_label_root, resize, mode='train')
# val_ds = ISIC2018(train_img_root, val_img_root, train_label_root, val_label_root, resize, mode='val')