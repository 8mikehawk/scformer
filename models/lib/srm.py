...
class SRM(nn.Module):
    def __init__(self, class_num=2, is_pretrained=False, pth_path=None, **kwargs):
    ...
    def _init_weights(self):
        # '/data/segformer/scformer/pretrain/mit_b2.pth'
        pretrained_dict=torch.load(self.pth_path)
