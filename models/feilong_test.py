...
#        self.linear_fuse1 = ConvModule(in_channels=embedding_dim * 2, out_channels=embedding_dim, kernel_size=1,norm_cfg=dict(type='BN', requires_grad=True))
        ...
        self.linear_fuse34 = nn.Sequential(nn.Conv2d(embedding_dim*2, embedding_dim, 1, bias=False),nn.SiLU())
        self.linear_fuse2 = nn.Sequential(nn.Conv2d(embedding_dim*2, embedding_dim, 1, bias=False),nn.SiLU())
        self.linear_fuse1 = nn.Sequential(nn.Conv2d(embedding_dim*2, embedding_dim, 1, bias=False),nn.SiLU())
